...
// refactored adventurer case function
int adventurerEffect(int currentPlayer, int drawntreasure, int temphand[], struct gameState* state, int handPos) {
    int z = 0, cardDrawn;
...
// refactored smithy case function
...
// refactored village case function
...
// refactored Great Hall case function
...
// refactored steward case function
...
//  int z = 0;// this is the counter for the temp hand
  ...
  switch( card )
    {
    case adventurer:
      return adventurerEffect(currentPlayer, drawntreasure, temphand, state, handPos);
